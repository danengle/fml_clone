  ...
  module HasChangeLog
    module Base
      ...
      module InstanceMethods # any method placed here will apply to instaces, like @hickwall  
        ...
        def record_changes
          logger.info { "*** inside record_changes #{attributes.inspect}" }
          changes = {}
...
# puts "*** just before ActiveRecord::Base.send :include, ChangeLogger::Model"
::ActiveRecord::Base.send :include, ChangeLogger::HasChangeLog::Base
