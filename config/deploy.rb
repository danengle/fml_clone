...
set :deploy_to, "/home/danengle/fml.danengle.us"

set :scm, :git
# Or: `accurev`, `bzr`, `cvs`, `darcs`, `git`, `mercurial`, `perforce`, `subversion` or `none`

role :web, "danengle.us"                          # Your HTTP server, Apache/etc
role :app, "danengle.us"                          # This may be the same as your `Web` server
role :db,  "danengle.us", :primary => true # This is where Rails migrations will run
